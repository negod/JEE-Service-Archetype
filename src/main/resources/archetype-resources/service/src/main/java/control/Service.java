...
import se.backede.web${artifactId}.${artifactId}.GenericRestService;
...
public class Service extends GenericRestService<ServiceEntity> {
     ...
     *
     * @summary Creates
     * @responseType ${package}.entity.ServiceEntity
     * @param entity
     */
    @POST
    @Path("/")
     ...
     * @responseType java.util.List<${package}.entity.ServiceEntity>
     */
    @POST
    @Path("/list")
    @Consumes({MediaType.APPLICATION_JSON})

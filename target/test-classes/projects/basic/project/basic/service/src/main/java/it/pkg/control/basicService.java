...
@Path("/basic")
@Stateless
public class basicService extends GenericRestService<basicEntity> {
     ...
     *
     * @summary Creates
     * @responseType it.pkg.entity.basicEntity
     * @param entity
     */
    @POST
    @Path("/")
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @Override
    public Response create(basicEntity entity) {
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @Override
    public Response update(@PathParam("id") String id, basicEntity entity) {
     ...
     * @responseType java.util.List<it.pkg.entity.basicEntity>
     */
    @POST
    @Path("/list")
    @Consumes({MediaType.APPLICATION_JSON})
